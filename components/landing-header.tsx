  ...
  return (
    ...
    >
      <div className="landing-header-shell mx-auto flex max-w-6xl items-center justify-between px-5 py-3 lg:px-7">
        <Link href="/" className="landing-brand group relative inline-flex items-center overflow-hidden rounded-full px-2 py-1">
        ...
        {props.actionType === "link" ? (
          <Link
            ...
            className="landing-header-cta group relative inline-flex items-center gap-2 overflow-hidden rounded-full px-5 py-2 text-[13px] font-semibold tracking-[-0.01em] text-white/85"
          >
