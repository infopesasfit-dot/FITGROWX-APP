...
import {
  Users, CreditCard,
  Send, BadgeAlert, Activity, Clock, UserPlus, ClipboardList, RefreshCw,
} from "lucide-react";
...
import { OwnerPhoneAlert } from "@/components/dashboard/OwnerPhoneAlert";
import { AutomationStats } from "@/components/dashboard/AutomationStats";
import { initials, fmt, last5Months, buildDonutSegments, MONTH_NAMES, getDinoState } from "@/lib/dashboard-helpers";
import { DashboardMetric, DashboardAlerts, DashboardSnapshot, RecenteAlumno, PlanDist, SetupFlags } from "@/types/dashboard";
...
export default function DashboardPage() {
  ...
  // QuickActions moved to /components/dashboard/QuickActions.tsx
  ...
  // Filters moved to /components/dashboard/Filters.tsx
