            ...
            <div style={{
              ...
              {planType === "full_marca" && gymLogoUrl
                ? // eslint-disable-next-line @next/next/no-img-element
                  <img src={gymLogoUrl} alt={gymDisplayName ?? "Logo"} style={{ height: 56, maxWidth: 180, objectFit: "contain", display: "block" }} />
                : <Image src="/images/logo-fondo-oscuro.png" alt="FitGrowX" width={180} height={56} style={{ height: 56, width: "auto", objectFit: "contain", display: "block" }} priority unoptimized />
              }
            </div>
          )}
          <button
